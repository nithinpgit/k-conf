      ...
      OT.getDevices(function(error, devices) {
        ...
        container.appendChild(
          createElement('div', { className: 'opentok-hardware-setup-camera' }, [
            createElement('div', { className: 'opentok-hardware-setup-label' }, '<i class="fa fa-video-camera" aria-hidden="true"></i>'),
        ...
        container.appendChild(createElement('div', { className: 'opentok-hardware-setup-mic' }, [
          createElement('div', { className: 'opentok-hardware-setup-label' }, '<i class="fa fa-microphone" aria-hidden="true"></i>'),
